...
//if want to change the files use another request or method it will be easy
...
const getWatchHistory = asyncHandler(async (req, res) => {
    ...
    return res
        .status(200)
        .json(new ApiResponse(200, user[0].watchHistory, "Watch History fetched Succefully"))
